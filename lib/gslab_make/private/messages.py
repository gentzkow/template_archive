...
# 4) Warnings
warning_glob = '\nWARNING! No files were returned by `glob_recursive` for path `%s` when walking to a depth of `%s`.'
warning_lyx_type = '\nWARNING! Document type `%s` unrecognized. Reverting to default of no special document type.'
warning_modified_files = "\nWARNING! The following target files have been modified according to git status:\n%s"
warning_git_file = "\nWARNING! There exists files tracked by git larger than the config suggested limit (%s MB)." 
warning_git_repo = "\nWARNING! Total size of files tracked by git larger than the config suggested limit (%s MB)."
warning_git_lfs_file = "\nWARNING! There exists files tracked by git lfs larger than the config suggested limit (%s MB)."
warning_git_lfs_repo = "\nWARNING! Total size of files tracked by git lfs larger than the config suggested limitt (%s MB)."

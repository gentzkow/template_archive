...
crit_error_bad_move = 'ERROR! Link/copy `%s` incorrectly specified. Link/copy should be specified in the following format: `destination | source`. Traceback can be found below.' 

...
\usepackage{code/beamer_themes/beamerthememetropolis_gslab}
\usepackage{code/beamer_themes/beamerinnerthememetropolis_gslab}
\usepackage{code/beamer_themes/beamerouterthememetropolis_gslab}
\usepackage{code/beamer_themes/beamercolorthememetropolis_gslab}
\usepackage{code/beamer_themes/beamerfontthememetropolis_gslab}
\AtEndPreamble{%
   \@ifpackageloaded{pgfplots}{%
     \RequirePackage{code/beamer_themes/pgfplotsthemetol_gslab}
   }{}
 }
